export const RESUME_DATA = {
    ...
    links: {
        github: "https://github.com/kariyawasamnaveen",
        linkedin: "https://linkedin.com/in/naveen-kariyawasam",
        email: "hknskariyawasamnaveen@gmail.com"
    },
    summary: "Agile Full-Stack & AI Solutions Remote Contractor. I bridge the gap between high-velocity product execution and scalable cloud engineering. Leveraging deep hands-on expertise in mobile architecture, modern backend services, and autonomous agent orchestration to ship production-ready systems on tight turnaround sprints.",
    skills: {
        core: ["Flutter", "Dart", "Python", "FastAPI", "Next.js", "TypeScript", "WebRTC", "PostgreSQL"],
        ai_and_data: ["LangChain", "Pinecone (RAG)", "OpenAI GPT", "Google Gemini", "Pandas", "Scikit-Learn"],
        integrations: ["Telegram Bot API", "Google Calendar API", "n8n", "Make.com", "Docker", "Git"]
    },
    experience: [
        {
